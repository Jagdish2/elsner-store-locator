...
class Elsner_Storelocator_Block_Adminhtml_Storelocator_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('storelocator_data') && Mage::registry('storelocator_data')->getId() ) {
            return Mage::helper('storelocator')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('storelocator_data')->getTitle()));
        } else {
